...
<%
String vendoredit = request.getParameter("vendor");
Database db = new Database();
PreparedStatement ps = db.getPS("select * from stock_management where vendor=?");
ps.setString(1, vendoredit);
...
<body>
<form class="form-inline center-content" action="filter.jsp" method="post">
  <div class="form-group">
    <label for="vendor" ">Search</label>  
    <input type="text" class="form-control" id="vendor" name="vendor" placeholder="vendor" value="<% out.println(vendor);%>">
  </div>
